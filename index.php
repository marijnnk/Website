			...
			<main>
				...
				<div class="wrapper">
					<article id="one">
						<h3>Ik</h3>
						<p>
							<img class="photo" src="media/marijn.jpg"/>Hoi! Ik ben Marijn, student Medisch Beeldvormende en Radiotherapeutische Technieken aan de Hanzehogeschool in Groningen. Ik ben fan van techniek, waaronder mechanische toetsenborden, de Raspberry Pi en Android. Verder ben ik graag creatief bezig. Ik gebruik mijn telefoon voor fotografie en ik gebruik Cinema&nbsp;4D om 3D-computergraphics te ontwerpen. Mijn werk kun je vinden in de <a href="galerij.php">galerij</a>. Deze site is zelf gemaakt.
						</p>
					</article>
					<article id="two">
						...
						<p class="joke">Wat links... ook al staan ze rechts</p>
						 <ul>
							...
							<li><a href="nostalgie.php"><i class="fas fa-camera-retro"></i>Nostalgie</a>
